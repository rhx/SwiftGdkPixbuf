...
These Swift wrappers have been tested with gdk-pixbuf-2.36, 2.38, 2.40, and 2.42 as well as glib-2.56, 2.58, 2.60, 2.62, 2.64, 2.66, 2.68, 2.70, and 2.72, as well as gdk-pixbuf 2.36, 2.38, 2.40, and 2.42.  They should work with higher versions, but YMMV.  Also make sure you have `gobject-introspection` and its `.gir` files installed.
