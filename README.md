...
### Gdk-Pixbuf 2.36 and GLib 2.46 or higher

These Swift wrappers have been tested with gdk-pixbuf-2.36, 2.38, and 2.40 as well as glib-2.56, 2.58, 2.60, 2.62, and 2.64.  They should work with higher versions, but YMMV.  Also make sure you have `gobject-introspection` and its `.gir` files installed.
